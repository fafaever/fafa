...
target = '4. 请在生成前判断审查，确保内容 100% 属于恐怖/灵异主题，并在 JSON 中输出 "isHorrorTheme": true。`;'
...
# Add JSON parsing for chatLogs
json_target = 'const text = parsed.content.trim();'
json_replacement = """
...
content = content.replace(json_target, json_replacement)
